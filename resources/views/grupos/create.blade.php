                ...
                <form action="{{ route('grupos.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <select
                            ...
                            <option value="A"
                                {{ old('nombre') == 'A' ? 'selected' : '' }}>
                                A
                            </option>

                            <option value="B"
                                {{ old('nombre') == 'B' ? 'selected' : '' }}>
                                B
                            </option>

                            <option value="C"
                                {{ old('nombre') == 'C' ? 'selected' : '' }}>
                                C
                            </option>

                            <option value="D"
                                {{ old('nombre') == 'D' ? 'selected' : '' }}>
                                D
                            </option>
                    ...
                    <div class="mb-6">
                        ...
                        <input
                            ...
                            id="ciclo_escolar"
                            name="ciclo_escolar"
                            value="{{ old('ciclo_escolar', date('Y')) }}"
                            min="2000"
                            max="2100"
                            required
                            class="w-full rounded-lg border-gray-300
